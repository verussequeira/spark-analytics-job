error id: file://<WORKSPACE>/src/main/java/com/company/analytics/instrumentation/LogMethod.java
file://<WORKSPACE>/src/main/java/com/company/analytics/instrumentation/LogMethod.java
...
```java
offset: 0
uri: file://<WORKSPACE>/src/main/java/com/company/analytics/instrumentation/LogMethod.java
text:
```scala
@@
```
...
QDox parse error in file://<WORKSPACE>/src/main/java/com/company/analytics/instrumentation/LogMethod.java